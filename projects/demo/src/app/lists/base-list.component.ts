...
export class BaseListComponent {
  ...
  public static generateRandomItem(): ListItem {
	  return {
		  ...
		  address: BaseListComponent.chance.address() + ', ' + BaseListComponent.chance.city() + ', ' + BaseListComponent.chance.state() + ', ' + BaseListComponent.chance.zip(),
  ...
  public prependItems(): void {
    this.filteredList.unshift(...BaseListComponent.generateMultipleRandomItems(10));
  }
  
  public appendItems(): void {
    this.filteredList.push(...BaseListComponent.generateMultipleRandomItems(10));
  }
